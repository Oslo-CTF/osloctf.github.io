	...
	created() {
		this.events = [
			...
			},
			{
				...
				link: 'https://discord.gg/hrJVeNUg?event=1195742024679305256',
			...
			},
			{
				...
				language: 'english/norwegian',
				stream: false,
				link: 'https://discord.gg/hrJVeNUg?event=1195741807380795494',
			...
			},
			{
				...
				language: 'english/norwegian',
				stream: false,
				link: 'https://discord.gg/hrJVeNUg?event=1195741554493632563',
				author: 'Marit og Christian, pwn powercouple. They started Oslo CTF together years ago, and are now working with cybersecurity abroad.',
